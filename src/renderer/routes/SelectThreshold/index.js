...
class SelectThreshold extends React.Component {
  ...
  handleConfirm = () => {
    this.props.dispatch(
      routerRedux.replace(`/initialize?m=${this.state.threshold}`)
    );
  };
  ...
  renderThreshold = index => {
    ...
    return (
      <li
        key={index}
        style={{ transform: `translate(${-100 * (threshold - 1)}%)` }}
      >
        <a>{index + 1}</a>
      </li>
    );
  ...
  render() {
    ...
    const leftArrowBg = leftArrowEnabled
      ? require('assets/btn_triangle_normal.png')
      : require('assets/btn_triangle_disabled.png');
    const rightArrowBg = rightArrowEnabled
      ? require('assets/btn_triangle_normal.png')
      : require('assets/btn_triangle_disabled.png');
          ...
          <div className={styles.hintArea}>
            ...
            <h4
              dangerouslySetInnerHTML={{
                __html: localizedStrings.minThresholdHint,
              }}
            />
          </div>
        ...
        <div className={styles.upper}>
          <div className={styles.card}>
            <div
              ...
              onClick={this.handleChangeThreshold.bind(
                this,
                -1,
                leftArrowEnabled
              )}
